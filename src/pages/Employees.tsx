...
const Employees: React.FC = () => {
  ...
  const employeesForRole = useMemo(
    () => filterEmployeesByRole(employees as any[], userRole, userDepartmentId),
  ...
  // Generate departments list from departments API (fallback to employees if empty)
      ...
      : [
          ...
          ...new Set(
            employeesForRole.map(
              (e: Employee) => e.department || 'Unassigned',
            ),
          ),
        ];
                                  ...
                                  <td className="p-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        ...
                                        {canSeeFullDetails && employee.employee_id && (
